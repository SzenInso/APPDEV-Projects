...
export default function Grocery(props) {
  ...
  function RemoveItem(item) {
    setCart(c => c.filter(cartItem => cartItem.id !== item.id));
  }
  ...
  function handlePayment() {
    ...
    if (isNaN(paidAmount) || paidAmount < totalPrice) {
      alert("Invalid payment amount. Please enter a value greater than or equal to the total price.");
      return;
    }
    ...
    setPayment(""); // Reset payment field
  }
